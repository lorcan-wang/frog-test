...
export const Message = {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					...
					message.dataBytes = MessageData.encode(message.data).finish()
					continue
				case 2:
					if (tag != 18) {
						break
	...
	toJSON(message: Message): unknown {
		...
		message.dataBytes !== undefined && (obj.dataBytes = message.dataBytes !== undefined ? base64FromBytes(message.dataBytes) : undefined)
		return obj
	},
...
export const MessageData = {
	...
	fromJSON(object: any): MessageData {
		return {
			...
			linkCompactStateBody: isSet(object.linkCompactStateBody) ? LinkCompactStateBody.fromJSON(object.linkCompactStateBody) : undefined,
		}
	},
	...
	toJSON(message: MessageData): unknown {
		...
		message.castAddBody !== undefined && (obj.castAddBody = message.castAddBody ? CastAddBody.toJSON(message.castAddBody) : undefined)
		...
		message.reactionBody !== undefined && (obj.reactionBody = message.reactionBody ? ReactionBody.toJSON(message.reactionBody) : undefined)
		...
		message.verificationRemoveBody !== undefined &&
			(obj.verificationRemoveBody = message.verificationRemoveBody
				...
				: undefined)
		message.userDataBody !== undefined && (obj.userDataBody = message.userDataBody ? UserDataBody.toJSON(message.userDataBody) : undefined)
		...
		message.linkCompactStateBody !== undefined &&
			(obj.linkCompactStateBody = message.linkCompactStateBody ? LinkCompactStateBody.toJSON(message.linkCompactStateBody) : undefined)
		return obj
	},
	...
	fromPartial<I extends Exact<DeepPartial<MessageData>, I>>(object: I): MessageData {
		...
		message.castAddBody =
			object.castAddBody !== undefined && object.castAddBody !== null ? CastAddBody.fromPartial(object.castAddBody) : undefined
		message.castRemoveBody =
			object.castRemoveBody !== undefined && object.castRemoveBody !== null ? CastRemoveBody.fromPartial(object.castRemoveBody) : undefined
		message.reactionBody =
			object.reactionBody !== undefined && object.reactionBody !== null ? ReactionBody.fromPartial(object.reactionBody) : undefined
		...
		message.userDataBody =
			object.userDataBody !== undefined && object.userDataBody !== null ? UserDataBody.fromPartial(object.userDataBody) : undefined
		message.linkBody = object.linkBody !== undefined && object.linkBody !== null ? LinkBody.fromPartial(object.linkBody) : undefined
		...
		message.linkCompactStateBody =
			object.linkCompactStateBody !== undefined && object.linkCompactStateBody !== null
...
export const Embed = {
	...
	fromPartial<I extends Exact<DeepPartial<Embed>, I>>(object: I): Embed {
		...
		message.castId = object.castId !== undefined && object.castId !== null ? CastId.fromPartial(object.castId) : undefined
		return message
	},
}
...
export const CastAddBody = {
	...
	fromJSON(object: any): CastAddBody {
		return {
			embedsDeprecated: Array.isArray(object?.embedsDeprecated) ? object.embedsDeprecated.map((e: any) => String(e)) : [],
			...
			mentionsPositions: Array.isArray(object?.mentionsPositions) ? object.mentionsPositions.map((e: any) => Number(e)) : [],
	...
	toJSON(message: CastAddBody): unknown {
		...
		message.parentCastId !== undefined && (obj.parentCastId = message.parentCastId ? CastId.toJSON(message.parentCastId) : undefined)
	...
	fromPartial<I extends Exact<DeepPartial<CastAddBody>, I>>(object: I): CastAddBody {
		...
		message.parentCastId =
			object.parentCastId !== undefined && object.parentCastId !== null ? CastId.fromPartial(object.parentCastId) : undefined
...
export const ReactionBody = {
	...
	toJSON(message: ReactionBody): unknown {
		...
		message.targetCastId !== undefined && (obj.targetCastId = message.targetCastId ? CastId.toJSON(message.targetCastId) : undefined)
	...
	fromPartial<I extends Exact<DeepPartial<ReactionBody>, I>>(object: I): ReactionBody {
		...
		message.targetCastId =
			object.targetCastId !== undefined && object.targetCastId !== null ? CastId.fromPartial(object.targetCastId) : undefined
...
export const VerificationAddAddressBody = {
	...
	toJSON(message: VerificationAddAddressBody): unknown {
		...
		message.claimSignature !== undefined &&
			(obj.claimSignature = base64FromBytes(message.claimSignature !== undefined ? message.claimSignature : new Uint8Array()))
...
export const FrameActionBody = {
	...
	toJSON(message: FrameActionBody): unknown {
		const obj: any = {}
		message.url !== undefined && (obj.url = base64FromBytes(message.url !== undefined ? message.url : new Uint8Array()))
		...
		message.state !== undefined && (obj.state = base64FromBytes(message.state !== undefined ? message.state : new Uint8Array()))
		message.transactionId !== undefined &&
			(obj.transactionId = base64FromBytes(message.transactionId !== undefined ? message.transactionId : new Uint8Array()))
		message.address !== undefined && (obj.address = base64FromBytes(message.address !== undefined ? message.address : new Uint8Array()))
		return obj
	},
